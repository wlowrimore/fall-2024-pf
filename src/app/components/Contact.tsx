    ...
    >
      <div className="w-full mb-16">
        ...
        <p className="pt-3 text-xl">
          I am always open to new opportunities. Please fel free to reach out to
          me by either filling out this messaging for, or by clicking one of the
          contact links provided below.
          <Link href="#">
